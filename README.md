# MIPE_EV1 GPIO Test Application

## Overview
This is a minimal GPIO test application for the MIPE_EV1 custom board based on the nRF54L15 SoC. The application demonstrates basic GPIO control and serves as a foundation for more complex firmware development.

## Hardware
- **Board**: MIPE_EV1 (custom design)
- **SoC**: nRF54L15 (ARM Cortex-M33, 128 MHz)
- **Test Pins**:
  - LED0: P0.00
  - LED1: P0.01
  - TestPin05: P1.05
